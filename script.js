function calcular() {
    ...
    if (soma <= 18.5) {
        ...
        saida.innerHTML += `<p>Seu texte deu ${soma}. Levemente acima do peso`
    }
    else if (soma >= 30 && soma <= 34.9) {
        saida.innerHTML += `<p>Seu texte deu ${soma}. Obesidade Grau I`
    }
    else if (soma >= 35 && soma <= 39.9) {
        saida.innerHTML += `<p>Seu texte deu ${soma}. Obesidade Grau II`
    }
    else {
        saida.innerHTML += `<p>Seu texte deu ${soma}. Obesidade Grau III`
    }
}